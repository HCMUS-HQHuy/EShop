...
const chat = {
  ...
  getConversation: (data: { participant2Id: number; participant1Role: string; participant2Role: string; context: {type: string, name: string} }) => api.post(`chat/conversation/get`, data),
